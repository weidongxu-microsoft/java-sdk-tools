...
describe("clean-java-source", () => {
  describe("isManagementPlaneModule", () => {
    ...
    it("should return true for management plane modules", () => {
      ...
      expect(
        isManagementPlaneModule("/path/to/azure-resourcemanager-compute"),
      ).toBe(true);
      expect(
        isManagementPlaneModule("/path/to/azure-resourcemanager-storage"),
      ).toBe(true);
      expect(
        isManagementPlaneModule("/path/to/azure-resourcemanager-network"),
      ).toBe(true);
      expect(
        isManagementPlaneModule("/path/to/azure-resourcemanager-keyvault"),
      ).toBe(true);
      expect(
        isManagementPlaneModule("/path/to/azure-resourcemanager-appservice"),
      ).toBe(true);
      expect(
        isManagementPlaneModule("/path/to/azure-resourcemanager-sql"),
      ).toBe(true);
    });
    ...
    it("should return true for management plane modules with complex paths", () => {
      ...
      expect(isManagementPlaneModule("../azure-resourcemanager-keyvault")).toBe(
        true,
      );
    });
    ...
    it("should return false for data plane modules", () => {
      ...
      expect(isManagementPlaneModule("/path/to/azure-storage-blob")).toBe(
        false,
      );
      expect(isManagementPlaneModule("/path/to/azure-keyvault-secrets")).toBe(
        false,
      );
      expect(
        isManagementPlaneModule("/path/to/azure-messaging-servicebus"),
      ).toBe(false);
    ...
    it("should return false for core and common modules", () => {
      expect(isManagementPlaneModule("/path/to/azure-core")).toBe(false);
      expect(isManagementPlaneModule("/path/to/azure-core-http-netty")).toBe(
        false,
      );
    ...
    it("should return false for Spring modules", () => {
      ...
      expect(isManagementPlaneModule("/path/to/azure-spring-cloud")).toBe(
        false,
      );
      expect(isManagementPlaneModule("/path/to/azure-spring-data-cosmos")).toBe(
        false,
      );
    });
    ...
    it("should return false for modules with similar but incorrect prefixes", () => {
      ...
      expect(isManagementPlaneModule("/path/to/azure-resource-manager")).toBe(
        false,
      );
      expect(isManagementPlaneModule("/path/to/azure-resourcemanager")).toBe(
        false,
      ); // Missing hyphen
      expect(isManagementPlaneModule("/path/to/resourcemanager-azure")).toBe(
        false,
      );
      expect(
        isManagementPlaneModule("/path/to/azure-resourcemanager_compute"),
      ).toBe(false); // Underscore instead of hyphen
      expect(
        isManagementPlaneModule("/path/to/azure-resourcemanagers-compute"),
      ).toBe(false); // Extra 's'
    });

    it("should handle edge cases", () => {
      // Test with empty or minimal paths
      expect(isManagementPlaneModule("azure-resourcemanager-compute")).toBe(
        true,
      );
      expect(isManagementPlaneModule("azure-resourcemanager-compute/")).toBe(
        true,
    ...
    it("should handle typical Azure SDK module names", () => {
      ...
      expect(
        isManagementPlaneModule("azure-resourcemanager-authorization"),
      ).toBe(true);
      expect(
        isManagementPlaneModule("azure-resourcemanager-cognitiveservices"),
      ).toBe(true);
      expect(
        isManagementPlaneModule("azure-resourcemanager-containerinstance"),
      ).toBe(true);
      expect(
        isManagementPlaneModule("azure-resourcemanager-containerregistry"),
      ).toBe(true);
      expect(
        isManagementPlaneModule("azure-resourcemanager-containerservice"),
      ).toBe(true);
      expect(isManagementPlaneModule("azure-resourcemanager-cosmosdb")).toBe(
        true,
      );
      expect(isManagementPlaneModule("azure-resourcemanager-dns")).toBe(true);
      expect(isManagementPlaneModule("azure-resourcemanager-eventhubs")).toBe(
        true,
      );
      expect(isManagementPlaneModule("azure-resourcemanager-monitor")).toBe(
        true,
      );
      expect(isManagementPlaneModule("azure-resourcemanager-resources")).toBe(
        true,
      );
    });
  });
